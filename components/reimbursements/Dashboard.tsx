...
export const Dashboard = ({ wallet, budgets, claims, onNewClaim, onEditClaim, onViewClaim }: any) => {
  ...
  const rejectedClaims = [
    ...
    { id: 'CLM-REJ-02', title: 'Cab to Airport', date: '05 Nov 2025', amount: '₹ 850', reason: 'Duplicate claim detected. This ride was already claimed in Report #CLM-09.' }
  ];
                ...
                {rejectedClaims.map((claim) => (
                   <div key={claim.id} className="p-4 rounded-xl border border-red-100 bg-red-50/30 space-y-3">
                      ...
                      <div className="flex justify-end">
                         <button className="text-[10px] font-bold text-slate-500 hover:text-slate-800 flex items-center gap-1">
