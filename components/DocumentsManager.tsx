...
const MOCK_DOCUMENTS: DocumentItem[] = [
  {
    ...
    generatedDate: '12 Jan 2023',
    status: 'Viewed',
    lastActivity: 'Viewed 15 Jan',
    generatedBy: 'Kavita Sharma (HR)',
    templateUsed: 'Standard Offer 2023',
    version: 1,
    size: '1.2 MB',
    history: [
  ...
  },
  {
    ...
    status: 'Downloaded',
    lastActivity: 'Downloaded yesterday',
    generatedBy: 'System (Auto)',
    templateUsed: 'Tax Certificate v2',
    version: 1,
    size: '450 KB'
  },
  {
    ...
    generatedDate: '01 Dec 2025',
    status: 'Draft',
    lastActivity: 'Edited 2 mins ago',
    generatedBy: 'Kavita Sharma (HR)',
    templateUsed: 'Increment Template A',
    version: 3,
    size: '180 KB'
  },
  {
    ...
    generatedDate: '30 Nov 2025',
    status: 'Pending Signature',
    lastActivity: 'Sent for e-sign 1 day ago',
    generatedBy: 'Rajesh Kumar (Finance)',
    templateUsed: 'Full & Final v4',
    version: 1,
    size: '2.1 MB'
  },
  {
    ...
    generatedDate: '05 Dec 2025',
    status: 'Approved',
    lastActivity: 'Approved by Manager',
    generatedBy: 'Ananya Patel',
    templateUsed: 'N/A (Upload)',
    version: 1,
    size: '3.5 MB'
  },
  {
    ...
    status: 'Sent',
    lastActivity: 'Email sent 20 Oct',
    generatedBy: 'System (Auto)',
    templateUsed: 'Bonus Distribution',
    version: 1,
    size: '120 KB'
  },
  {
    ...
    generatedDate: '28 Nov 2025',
    status: 'Sent',
    lastActivity: 'Email sent 28 Nov',
    generatedBy: 'Kavita Sharma (HR)',
    templateUsed: 'Exit Pack Standard',
    version: 1,
    size: '800 KB'
  },
  {
    ...
    generatedDate: '10 Dec 2025',
    status: 'Pending Signature',
    lastActivity: 'Uploaded by Employee',
  ...
  },
  {
    ...
    generatedDate: '15 Nov 2025',
    status: 'Viewed',
    lastActivity: 'Viewed 16 Nov',
    generatedBy: 'Kavita Sharma (HR)',
    templateUsed: 'Confirmation v1',
    version: 1,
    size: '200 KB'
  },
  {
    ...
    generatedDate: '15 Jun 2025',
    status: 'Sent',
    lastActivity: 'Email sent 15 Jun',
    generatedBy: 'System (Auto)',
    templateUsed: 'Tax Certificate v2',
    version: 1,
    size: '450 KB'
...
const MOCK_FORMS_16 = Array.from({ length: 15 }).map((_, i) => ({
    ...MOCK_DOCUMENTS[1],
    id: `F16-${i}`,
    employeeName: ['Arjun Mehta', 'Priya Desai', 'Vikram Singh', 'Rahul Sharma', 'Ananya Patel'][i % 5],
    employeeId: `TF00${800 + i}`,
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="flex items-center gap-2 p-2 border border-slate-200 rounded-lg bg-slate-50">
                            <span className="text-xs font-medium px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-full">{doc.employeeName}</span>
                            <span className="text-xs text-slate-400 flex-1">({doc.employeeId}@collabcrm.com)</span>
                        </div>
                    </div>
                    <div>
...
This is a placeholder file generated for demonstration purposes.
    ...
    link.href = url;
    link.download = `${doc.title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}_${doc.employeeId}.txt`;
  ...
  const handleEmailSent = () => {
      const emailEvent: Note = {
          id: Date.now().toString(),
          text: `Document emailed to ${doc.employeeName}`,
          author: 'System',
          timestamp: 'Just now',
          type: 'SYSTEM'
      };
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col transform transition-all relative min-h-[550px]">
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-start bg-slate-50/50">
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Generated by {doc.generatedBy}</p>
                </div>
                     ...
                     <div className="p-8 flex flex-col items-center justify-center h-full animate-in fade-in">
                        ...
                        <div className="mt-6 w-full px-6 grid grid-cols-2 gap-4 text-sm bg-white p-4 rounded-xl border border-slate-100 shadow-sm">
                            <div>
                                ...
                                <p className="font-semibold text-slate-700 text-xs mt-0.5">{doc.templateUsed}</p>
                            </div>
                            <div>
                  ...
                  <tbody className="divide-y divide-slate-100">
                     {filteredDocs.map((doc) => (
                        ...
                        >
                           ...
                           <td className="px-6 py-4 whitespace-nowrap text-slate-500">{doc.generatedDate}</td>
                           <td className="px-6 py-4">
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold border ${getStatusStyle(doc.status)}`}>
                                 {doc.status}
                              </span>
                           </td>
                           <td className="px-6 py-4 text-xs text-slate-500">{doc.lastActivity}</td>
                           <td className="px-4 py-4 text-right">
