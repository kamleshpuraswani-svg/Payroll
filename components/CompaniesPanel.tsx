            ...
            <tbody className="divide-y divide-slate-100">
              {companies.map((company) => (
                <tr key={company.id} className="hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-xs font-mono text-slate-500 bg-slate-100 px-2 py-1 rounded w-fit">{company.id}</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-sm font-medium text-slate-700">{company.employees.toLocaleString()}</div>
                  </td>
                  <td className="px-6 py-4">
