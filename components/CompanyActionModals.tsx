               ...
               <div key={alert.id} className="p-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors bg-white shadow-sm">
                  <div className="flex justify-between items-start mb-2">
                     ...
                     <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${
                        alert.severity === 'High' ? 'bg-rose-50 text-rose-700' : 
          ...
          <div className="space-y-6">
             ...
             <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col h-full">
                   ...
                   <p className="text-xs text-slate-500 mt-1 mb-4">Send via registered Email & SMS.</p>
    ...
    <>
            ...
            {[
              ...
              { id: 6, label: 'Disburse' }
               ...
               return (
                  ...
                  >
                     <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow-sm ring-4 ring-white transition-all ${
                        isActive ? 'bg-sky-600 text-white ring-sky-100 scale-110' : 
      ...
      <div className="bg-white border-t border-slate-200 px-8 py-4 flex justify-between items-center shrink-0">
         {currentStep > 1 && currentStep < 6 ? (
           ...
           <button onClick={() => setCurrentStep(1)} className="px-6 py-2.5 text-slate-600 hover:bg-slate-50 rounded-lg font-medium text-sm transition-colors flex items-center gap-2 border border-slate-200">
              <RotateCcw size={16} /> Run Another Payroll
           </button>
         ) : (
