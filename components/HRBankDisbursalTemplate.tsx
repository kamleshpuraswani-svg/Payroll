...
const HRBankDisbursalTemplate: React.FC = () => {
               ...
               <div className="flex items-center gap-4">
                   ...
                   <div>
                       <div className="text-xs text-slate-500 flex gap-2 items-center">
                           <span>Bank Format</span> <span className="text-slate-300">/</span> <span className="uppercase font-bold text-xs text-purple-600">{view} MODE</span>
                       </div>
                       {isReadOnly ? (
...
export default HRBankDisbursalTemplate;
