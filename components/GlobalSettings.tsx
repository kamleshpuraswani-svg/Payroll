...
const GlobalSettings: React.FC<GlobalSettingsProps> = ({ userRole }) => {
   ...
   const menuItems = [
      ...
      { id: 'payslip', label: 'Payslip Templates', icon: FileText },
   ...
   const renderContent = () => {
      switch (activeModule) {
         ...
         case 'statutory': return <StatutorySettings userRole={userRole} />;
         case 'pf-tds': return <PfTdsSettings userRole={userRole} />;
