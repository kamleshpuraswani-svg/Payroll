...
const StatutorySettings: React.FC<StatutorySettingsProps> = ({ userRole }) => {
    ...
    const [gratuityProrationIncompleteYear, setGratuityProrationIncompleteYear] = useState(true);
    const [gratuityWaiveMinServiceDeathDisablement, setGratuityWaiveMinServiceDeathDisablement] = useState(true);
    const [gratuityPaymentReminder, setGratuityPaymentReminder] = useState(true);
    ...
    const handleCancel = () => {
        if (backupState) {
            ...
            setGratuityProrationIncompleteYear(backupState.gratuityProrationIncompleteYear);
            setGratuityWaiveMinServiceDeathDisablement(backupState.gratuityWaiveMinServiceDeathDisablement);
            setGratuityPaymentReminder(backupState.gratuityPaymentReminder);
                        ...
                        {enableEsi && (
                            <div className="space-y-8 animate-in fade-in">
                                ...
                                <div className="space-y-6 pt-2">
                                    ...
                                    {includeEmprContriEsi && (
                                        <label className="flex items-start gap-3 cursor-pointer group pt-2 ml-8 animate-in fade-in slide-in-from-top-2">
                            ...
                            The Payment of Gratuity Act, 1972 is applicable to establishments with 10 or more employees. It is a lump-sum payment made by the employer as a mark of recognition for the service rendered by the employee.
                                ...
                                {enableGratuity && (
                                 ...
                                 <div className="pt-8 border-t border-slate-300">
                                     ...
                                     {includeInCtcGratuity && userRole === 'HR_MANAGER' && (
                                 ...
                                 <div className="mt-8">
                                     <label className="flex items-center gap-3 cursor-pointer group w-fit">
                                         ...
                                         <input
                                             type="checkbox"
                                             className="hidden"
                                             checked={gratuityProrationIncompleteYear}
                                 ...
                                 <div className="mt-6">
                                     <label className="flex items-center gap-3 cursor-pointer group w-fit">
                                         ...
                                         <input
                                             type="checkbox"
                                             className="hidden"
                                             checked={gratuityWaiveMinServiceDeathDisablement}
                                 ...
                                 <div className="mt-6">
                                     <label className="flex items-center gap-3 cursor-pointer group w-fit">
                                         ...
                                         <input
                                             type="checkbox"
                                             className="hidden"
                                             checked={gratuityPaymentReminder}
