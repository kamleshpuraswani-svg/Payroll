        ...
        <div className="min-h-screen bg-[#F8FAFC] p-4 lg:p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-5">
                        <div className="p-4 bg-sky-500 rounded-3xl shadow-lg shadow-sky-200">
                            <Building2 className="text-white" size={32} strokeWidth={2.5} />
                        </div>
                        <div>
                            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Statutory Settings</h2>
                ...
                <div className="space-y-6">
                    {/* PF Section */}
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-500 group">
                        <div 
                            ...
                            <div className="flex items-center gap-4">
                                {isEditingPf ? (
                                    <div className="flex gap-2" onClick={e => e.stopPropagation()}>
                                        ...
                                        <button onClick={handleSavePf} className="px-6 py-2 bg-sky-500 text-white rounded-xl font-black text-xs shadow-lg shadow-sky-100 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 uppercase tracking-wider"><Save size={14} /> Save</button>
                                    </div>
                                ) : (
                            ...
                            <div className="p-8 space-y-10 animate-in fade-in slide-in-from-top-4 duration-500">
                                {!enablePf && !isEditingPf ? (
                                    <div className="py-16 flex flex-col items-center text-center">
                                        <div className="bg-slate-50 p-8 rounded-full mb-6 border border-slate-100 shadow-inner group-hover:scale-110 transition-transform duration-500">
                                            <Shield size={56} className="text-slate-300" strokeWidth={1.5} />
                                        </div>
                                        <h3 className="text-2xl font-black text-slate-400">Provident Fund is Disabled</h3>
                                        <p className="text-slate-400 mt-2 max-w-sm font-medium">Enable PF settings to configure contribution rates and establishment details.</p>
                                    </div>
                                ) : (
                                    <div className={`space-y-10 transition-all duration-500 ${!enablePf ? 'opacity-40 grayscale pointer-events-none' : ''}`}>
                                        {/* PF Top Toggle */}
                                        <div className="bg-slate-50/50 rounded-3xl p-6 border border-slate-100 flex justify-between items-center group/toggle">
                                            <div className="flex items-center gap-4">
                                            ...
                                            <label className={`relative inline-flex items-center cursor-pointer ${!isEditingPf && 'pointer-events-none opacity-50'}`}>
                                        ...
                                        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                                            ...
                                            <div className="xl:col-span-4">
                                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-8 border border-amber-100 shadow-sm sticky top-32">
                            ...
                            <div className="flex items-center gap-4">
                                {isEditingTds ? (
                                    <div className="flex gap-2" onClick={e => e.stopPropagation()}>
                                        ...
                                        <button onClick={handleSaveTds} className="px-6 py-2 bg-indigo-600 text-white rounded-xl font-black text-xs shadow-lg shadow-indigo-100 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 uppercase tracking-wider"><Save size={14} /> Save</button>
                                    </div>
                                ) : (
                        ...
                        {tdsExpanded && (
                            <div className="p-8 space-y-10 animate-in fade-in slide-in-from-top-4 duration-500">
                                {!enableTds && !isEditingTds ? (
                                    <div className="py-16 flex flex-col items-center text-center">
                                        <div className="bg-slate-50 p-8 rounded-full mb-6 border border-slate-100 shadow-inner group-hover:scale-110 transition-transform duration-500">
                                            <Landmark size={56} className="text-slate-300" strokeWidth={1.5} />
                                        </div>
                                        <h3 className="text-2xl font-black text-slate-400">TDS Configuration is Disabled</h3>
                                        <p className="text-slate-400 mt-2 max-w-sm font-medium">Enable TDS settings to configure TAN and tax withholding parameters.</p>
                                    </div>
                                ) : (
                                    <div className={`space-y-10 transition-all duration-500 ${!enableTds ? 'opacity-40 grayscale pointer-events-none' : ''}`}>
                                        {/* TDS Top Toggle */}
                                        <div className="bg-slate-50/50 rounded-3xl p-6 border border-slate-100 flex justify-between items-center group/toggle">
                                            <div className="flex items-center gap-4">
                                        ...
                                        <div className="bg-sky-50 border border-sky-100 rounded-3xl p-6 flex items-start gap-5">
            ...
            {showSplitupModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg flex flex-col animate-in zoom-in-95 duration-300 border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-8 bg-slate-50 border-t border-slate-100 flex justify-end">
                            <button onClick={() => setShowSplitupModal(false)} className="px-8 py-3 bg-slate-900 text-white rounded-2xl font-black text-xs shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all uppercase tracking-widest">Close Distribution</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {showBelowLimitModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white rounded-[40px] shadow-2xl w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-100 flex flex-col">
                        <div className="px-10 py-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-sky-500 text-white rounded-[20px] shadow-lg shadow-sky-100">
                                    <Calculator size={24} strokeWidth={2.5} />
                                </div>
                                <div>
                                    <h3 className="text-2xl font-black text-slate-900 tracking-tight">EPF Calculation Model</h3>
                        ...
                        <div className="p-10 space-y-10 overflow-y-auto custom-scrollbar flex-1 max-h-[60vh]">
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    {['Basic Salary', 'HRA', 'Dearness Allowances (DA)'].map(comp => (
                                        <label key={comp} onClick={() => toggleBelowLimitComponent(comp)} className={`flex items-center gap-3 p-4 border-2 rounded-3xl cursor-pointer transition-all ${belowLimitComponents.includes(comp) ? 'bg-sky-50 border-sky-400 shadow-md' : 'bg-white border-slate-100 hover:border-slate-300'}`}>
                            ...
                            <div className="bg-amber-50 rounded-[32px] p-6 border-2 border-amber-100/50 flex gap-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <div className="p-6 bg-slate-50 rounded-[28px] border border-slate-100 flex justify-between items-center group hover:bg-white hover:shadow-xl transition-all">
                        ...
                        <div className="px-10 py-8 bg-slate-50 border-t border-slate-100 flex justify-end">
                            <button onClick={() => setShowBelowLimitModal(false)} className="px-12 py-4 bg-slate-900 text-white rounded-3xl font-black text-sm shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all hover:scale-105 active:scale-95 uppercase tracking-widest">Got it</button>
                        </div>
                    </div>
                </div>
            )}
