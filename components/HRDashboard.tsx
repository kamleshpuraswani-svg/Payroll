                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3 w-full xl:w-auto">
                            ...
                            <div className="relative w-full sm:w-auto">
                                ...
                                >
                                    ...
                                    <ChevronDown size={14} className={`text-slate-400 transition-transform ${isFilterPopoverOpen ? 'rotate-180' : ''}`} />
                                </button>
                                            ...
                                            <div className="grid grid-cols-3 gap-2 mb-4">
                                                {['This Month', 'Last Month', 'This Quarter', 'Last Quarter', 'This Year', 'Last Year'].map(label => (
                                                    <button
                                                        ...
                                                        className={`px-2 py-2 text-[11px] font-bold rounded-lg transition-all border ${tdsTimeRange === label
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            if (e.target.value) {
                                                                ...
                                                                // Extract month/year name for display if needed, but for now just label as Custom
                                                                setIsFilterPopoverOpen(false);
                                                            }
                                                        }}
                                                    />
